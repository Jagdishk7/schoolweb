            ...
            <div className="row">                
                <div className="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                    <div className="inner-column">
                        ...
                        <div className="text">In present situation of world, ICOESS is commited to provide adative services & solutions to our cusomers. ICOESS helps businesses thrive in a world defined by disruption and fueled by transformative technology.</div>
                      
                        <div className="btn-box">
                            <a href="https://icoesolution.com/" target="_blank" className="theme-btn btn-style-one">Contact Us</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="image-column col-lg-6 col-md-12 col-sm-12">
                    <div className="inner-column wow fadeInLeft">
                      <div className="author-desc">
                        <h2>ICOES Solutions</h2>
                        <span>Software & Services</span>
                      </div>
                        <figure className="image-1"><a href="/" className="lightbox-image" data-fancybox="images"><img title="Rahul Kumar Yadav" src="assets/about.jpg" alt="" /></a></figure>
